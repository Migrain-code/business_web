...
@section('title', 'Personel Prim Takibi')
@section('styles')
        ...
        <div class="card pt-4 mb-6 mb-xl-9 ">
            ...
            <div class="card-header border-0">
                ...
                <div class="card-title" style="display: block;">
                    <h2 style="margin-bottom: 10px;margin-top: 5px;">Prim Takibi</h2>
                </div>
        ...
        <div class="row" id="printTable">
                ...
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="card-title">
                            <h2 class="fw-bold">Hizmet Gideri</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body pt-0">
                        <div class="fw-bold fs-2">
                            ₺{{$personel->totalServicePrice()}} <span class="text-muted fs-4 fw-semibold">Türk Lirası</span>
                            <div class="fs-7 fw-normal text-muted">Personelin Vermiş Olduğu Hizmetlerden Yapılan Kazanç.</div>
                        </div>
                    </div>
                    <!--end::Card body-->
                </div>
            ...
            <div class="col-6">
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-header border-0">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2 class="fw-bold">Ürün Satış Gideri</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body pt-0">
                        <div class="fw-bold fs-2">
                            ₺{{$personel->totalSalePrice()}} <span class="text-muted fs-4 fw-semibold">Türk Lirası</span>
                            <div class="fs-7 fw-normal text-muted">Personelin Yapmış Olduğu Satışlardan Yapılan Kazanç.</div>
                        </div>
                    </div>
                    <!--end::Card body-->
                </div>
            ...
            <div class="col-12">
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-body pt-0">
                        <div class="fw-bold fs-2">
                            ₺{{$personel->totalPrim()}} <span class="text-muted fs-4 fw-semibold">Türk Lirası</span>
                            <div class="fs-7 fw-normal text-muted">Toplam.</div>
                        </div>
                    </div>
                    <!--end::Card body-->
                </div>
