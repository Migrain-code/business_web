...
@section('breadcrumbs')
    ...
    <!--begin::Item-->
    <li class="breadcrumb-item text-gray-600 fw-bold lh-1">
        <a href="{{route('personel.adission.index')}}"> Adisyonlar </a>
    </li>
    <!--end::Item-->
    <li class="breadcrumb-item">
        <i class="ki-duotone ki-right fs-3 text-gray-500 mx-n1"></i></li>
...
@section('content')
    <div id="kt_app_content" class="app-content ">
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10">
            <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                ...
                <!--begin::Button-->
                <a href="{{route('personel.adission.index')}}"
                        ...
                        <div class="btn-wrapper">
                            ...
                            <div
                                ...
                                <!--end::Heading-->
                                    ...
                                    <form method="post"
                                          action="{{route('personel.adission.update', $appointment->id)}}"
                                          id="approveForm">
                                        @csrf
                                        @method('PUT')
                                    </form>
                                ...
                                <!--begin::Menu item-->
                                    ...
                                    <form method="post"
                                          action="{{route('personel.adission.destroy', $appointment->id)}}"
                                          id="cancelForm">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                ...
                                <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        <a href="{{route('personel.adission.edit', $appointment->id)}}"
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="{{route('personel.adission.paymentClose', $appointment->id)}}"
            ...
            <div class="tab-content">
                @include('personel.adission.edit.parts.tab-1')
                @include('personel.adission.edit.parts.tab-2')
                @include('personel.adission.edit.parts.tab-3')
                @include('personel.adission.edit.parts.tab-4')
                @include('personel.adission.edit.parts.tab-5')
    ...
    @include('personel.adission.edit.modals.add-service')
    @include('personel.adission.edit.modals.add-sale')
    @include('personel.adission.edit.modals.add-cash-point')
    @include('personel.adission.edit.modals.add-collection')
    @include('personel.adission.edit.modals.add-receivable')

@endsection
@section('scripts')
    {{-- Ürün Satış Listesi --}}
    <script src="/business/assets/js/project/personel-account/adission/edit/sale/listing.js"></script>
    <script>
        let DATA_URL = "{{route('personel.adission.sale.datatable', $appointment->id)}}";
        let DATA_COLUMNS = [
            {data: 'id'},
            {data: 'created_at'},
            {data: 'customerName'},
    ...
    <script>
        function fetchProductCreateInfos() {
            ...
            $.ajax({
                url: '/personel/adission/' + {{$appointment->id}} + '/sale/create',
                type: "GET",
                dataType: "JSON",
        ...
        function fethPaymentInfo() {
            $.ajax({
                url: '/personel/adission/' + {{$appointment->id}} + '/payment',
                type: "GET",
                dataType: "JSON",
                success: function (res) {
                    console.log(res);
        ...
        function fetchCashPointInfos() {
            ...
            $.ajax({
                url: '/personel/adission/' + {{$appointment->id}} + '/cash-point',
                type: "GET",
                dataType: "JSON",
                success: function (res) {
    ...
    <script src="/business/assets/js/project/personel-account/adission/edit/payments/add-payment.js"></script>
    <script src="/business/assets/js/project/adission/edit/payments/fetchPaymentList.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/tr.js"></script>
    <script src="/business/assets/js/project/personel-account/adission/edit/receivable/add-receivable.js"></script>
    <script src="/business/assets/js/project/personel-account/adission/edit/receivable/fetchReceivableList.js"></script>
        ...
        $('.addCashPoint').on('click', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/personel/adission/'+adissionId+'/payment/save',
                        type: "POST",
                        data: {
                            "_token": csrf_token,
                            'isPoint': 1,
