    ...
    <div id="kt_app_content" class="app-content ">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
               ...
               @include('personel.adission.parts.toolbar')
            </div>
            <!--end::Card header-->
...
@section('scripts')
    ...
    <script src="/business/assets/js/project/personel-account/adission/listing.js"></script>

    <script>
        let DATA_URL = "{{route('personel.adission.datatable')}}";
        let DATA_COLUMNS = [
            {data: 'customerName'},
            {data: 'customerPhone'},
            {data: 'services'},
