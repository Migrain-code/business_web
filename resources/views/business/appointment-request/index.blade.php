    ...
    <div id="kt_app_content" class="app-content ">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                @include('business.appointment-request.parts.toolbar')
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Arama Durumu</th>
...
@section('scripts')
    ...
    <script src="/business/assets/js/project/appointment-request/listing/listing.js"></script>

    <script>
        let DATA_URL = "{{route('business.appointment-request.datatable')}}";
        let DATA_COLUMNS = [
            {data: 'id'},
            {data: 'service_name'},
            {data: 'user_name'},
