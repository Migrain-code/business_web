    ...
    <div id="kt_app_content" class="app-content">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                @include('business.invoice.parts.toolbar')
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Fatura Numarası</th>
                        <th class="min-w-125px">Fiyatı</th>
                        <th class="min-w-125px">Durum</th>
                        <th class="min-w-125px">KDV</th>
                        <th class="min-w-125px">Toplam</th>
...
@section('scripts')
    ...
    <script src="/business/assets/js/project/invoice/listing/listing.js"></script>
