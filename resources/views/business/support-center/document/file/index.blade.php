...
@section('breadcrumbs')
    ...
    <!--begin::Item-->
    <li class="breadcrumb-item text-gray-600 fw-bold lh-1">
        <a href="{{route('business.support.document')}}">Dökümanlar</a>
    </li>
    <!--end::Item-->
    <!--end::Item-->
    <li class="breadcrumb-item">
                                ...
                                <td data-order="account">
                                    <div class="d-flex align-items-center">
                                        <span class="icon-wrapper">
                                            <i class="ki-duotone ki-file-down fs-2x text-primary me-4">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        </span>
                                        <a href="{{image($file->way)}}" class="text-gray-800 text-hover-primary" download>{{$file->name}}</a>
                                    </div>
                                </td>
                                <td>
                                    {{$file->size}}
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{image($file->way)}}" target="_blank" class="menu-link px-3">
                                                        Aç
                                                    </a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{image($file->way)}}" download class="menu-link px-3" data-kt-filemanager-table="rename">
                                                       İndir
                                                    </a>
                                                </div>
                                                <!--end::Menu item-->
