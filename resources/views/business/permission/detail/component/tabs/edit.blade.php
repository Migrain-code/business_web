        ...
        <div class="card-body pt-0 pb-5">
            ...
            <form class="form" action="#" id="kt_ecommerce_customer_profile">
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <select name="customer_id" id="personel_id" aria-label="Müşteri Seçiniz" data-control="select2" data-placeholder="Müşteri Seçiniz..." data-dropdown-parent="#kt_ecommerce_customer_profile" class="form-select form-select-solid fw-bold">
                        ...
                        @foreach($customers as $customer)
                            <option value="{{$customer->customer->id}}" @selected($dep->customer_id == $customer->customer->id)>{{$customer->customer->name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" class="form-control form-control-solid" placeholder="" name="price" value="{{$dep->price}}" />
                    <!--end::Input-->
                </div>
                <!--begin::İşlem Tarihi-->
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semibold mb-2">Ödeme Tarihi
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Ödeme Tarihi"></i>
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-solid" id="kt_ecommerce_edit_order_date" placeholder="" name="operation_date" value="{{$dep->payment_date}}" />
                    <!--end::Input-->
                </div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <label class="required fs-6 fw-semibold mb-2">Not
                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Borca eklemek istediğiniz not varsa"></i>
                    </label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <textarea type="text" class="form-control form-control-solid" placeholder="" name="note" rows="5">{{$dep->note}}</textarea>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--end::Row-->
