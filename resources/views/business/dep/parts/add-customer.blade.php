                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="customer_id" id="personel_id" aria-label="Müşteri Seçiniz" data-control="select2" data-placeholder="Müşteri Seçiniz..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="required fs-6 fw-semibold mb-2">Tutar
                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Borcunuzun Tutarı"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="required fs-6 fw-semibold mb-2">Not
                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Borcunuza eklemek istediğiniz not varsa"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
