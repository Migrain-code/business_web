...
@section('breadcrumbs')
    ...
    <!--begin::Item-->
    <li class="breadcrumb-item text-gray-600 fw-bold lh-1">
        <a href="{{route('business.receivable.index')}}"> Alacaklar </a>
    </li>
    <!--end::Item-->
    <li class="breadcrumb-item">
        <i class="ki-duotone ki-right fs-3 text-gray-500 mx-n1"></i></li>
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                ...
                <div class="tab-content" id="myTabContent">
                    @include('business.receivable.detail.component.tabs.edit')
...
@section('scripts')
    <script>
        let updateUrl = "{{route('business.receivable.update', $receivable->id)}}";
    </script>

    <script src="/business/assets/js/project/receivable/details/update-profile.js"></script>
    <script>
