...
@section('breadcrumbs')
    ...
    <!--begin::Item-->
    <li class="breadcrumb-item text-gray-600 fw-bold lh-1">
        <a href="{{route('business.request-form.index')}}"> Formlar </a>
    </li>
    <!--end::Item-->
    <li class="breadcrumb-item">
        <i class="ki-duotone ki-right fs-3 text-gray-500 mx-n1"></i></li>
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                           href="#appointment_request_form_question">Sorular</a>
                    </li>
                    <!--end:::Tab item-->
                </ul>
                <!--end:::Tabs-->
                ...
                <div class="tab-content" id="myTabContent">
                    @include('business.appointment-request-form.detail.component.tabs.edit')
                    @include('business.appointment-request-form.detail.component.tabs.qustions')
...
@section('scripts')
    <script>
        let updateUrl = "{{route('business.request-form.update', $requestForm->id)}}";
    </script>
