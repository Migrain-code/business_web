<!--begin:::Tab pane-->
<div class="tab-pane fade" id="kt_ecommerce_customer_recevivable" role="tabpanel">
    <!--begin::Card-->
    <div class="card pt-4 mb-6 mb-xl-9">
        @can('customer.receivable.show')
        <!--begin::Card header-->
        <div class="card-header border-0">
            <!--begin::Card title-->
            <div class="card-title" style="display: block;">
                <h2 style="margin-bottom: 10px;margin-top: 5px;">Salona Borçları</h2>
                <h4>Toplam Borç: <span id="totalReceviable"></span></h4>
            </div>
        ...
        <div class="card-body pt-0 pb-5">
            ...
            <div class="table-responsive">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="receivableDataTable">
                    <thead>
                        <tr>
                            <td class="min-w-125px">Planlanan Ödeme Tarihi</td>
                            <td class="min-w-125px">Borç Türü</td>
        ...
        @else
            <div class="card-body">
                <x-forbidden-component title="Yetkisiz Erişim" message="Müşteri Borçlarını Görüntülemek için yetkiniz bulunmamaktadır"></x-forbidden-component>
            </div>
        @endcan
    </div>
