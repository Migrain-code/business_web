<!--begin:::Tab pane-->
<div class="tab-pane fade" id="kt_ecommerce_customer_payments" role="tabpanel">
    <!--begin::Card-->
    <div class="card pt-4 mb-6 mb-xl-9">
        @can('customer.payment.show')
        <!--begin::Card header-->
        <div class="card-header border-0">
            <!--begin::Card title-->
            <div class="card-title" style="display: block;">
                <h2 style="margin-bottom: 10px;margin-top: 5px;">Ödemeleri</h2>
                <h4>Toplam Ödeme: <span id="totalPayment"></span></h4>
            </div>
            <div class="d-flex align-items-center">
                ...
                <!--begin::Menu-->
                <div id="kt_ecommerce_report_customer_orders_export_menu_payment" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                    <!--begin::Menu item-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="paymentDataTable">
                    <thead>
                        <tr>
                            ...
                            <td class="min-w-125px">Ödeme Türü</td>
                            <td class="min-w-125px">Fiyat</td>
        ...
        @else
            <div class="card-body">
                <x-forbidden-component title="Yetkisiz Erişim" message="Müşteri Ödemelerini Görüntülemek için yetkiniz bulunmamaktadır"></x-forbidden-component>
            </div>
        @endcan
    </div>
