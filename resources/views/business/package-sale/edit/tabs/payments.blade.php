...
<div class="tab-pane fade active show" id="kt_ecommerce_customer_payments" role="tabpanel">
    ...
    <div class="card pt-4 mb-6 mb-xl-9 border-0">
        ...
        @else
            <div class="card-body">
                <x-forbidden-component title="Yetkisiz Erişim" message="Pakete Ödeme Eklemek, Listelemek ve silmek için yetkiniz bulunmamaktadır"></x-forbidden-component>
            </div>
        @endcan
    </div>
</div>
