...
@section('content')
    <div id="kt_app_content" class="app-content ">
        ...
        <!--begin::Form-->
        <form id="kt_ecommerce_add_product_form" method="post" enctype="multipart/form-data" action="{{route('business.personel.store')}}" class="form d-flex flex-column flex-lg-row">
            @csrf
            <!--begin::Aside column-->
            @include('business.personel.create.parts.col-1')
            <!--end::Aside column-->
            <!--begin::Main column-->
            @include('business.personel.create.parts.col-2')
            <!--end::Main column-->
            <!--begin::Service column-->
            @include('business.personel.create.parts.col-3')
            <!--end::Service column-->
        </form>
        <div class="d-flex justify-content-end flex-row">

            <!--begin::Button-->
            <button type="submit" id="kt_ecommerce_add_product_submit" onclick="$('#kt_ecommerce_add_product_form').submit()" class="btn btn-primary w-100 mt-3">
