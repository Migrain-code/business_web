                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select mb-2" name="paymentType" data-control="select2" data-hide-search="true"
                                    data-placeholder="Ödeme Tipi Seçiniz" id="kt_ecommerce_add_product_status_select">
                                <option></option>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid formatDateInput" placeholder="" name="operationDate" value="" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" class="form-control form-control-solid" placeholder="Örn. 15" name="payment_price" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
