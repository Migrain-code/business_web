        ...
        <div class="modal-content">
            ...
            <form class="form" action="#" id="kt_modal_add_personel_stay_off_day">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <input type="hidden" class="form-control form-control-solid" placeholder="" name="personels" value="{{$personel->id}}" />
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid formatDateInput" placeholder="" name="start_time" value="" />
                                <!--end::Input-->
                        </div>
                        <div class="fv-row">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="İzin Bitiş Tarihi"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid formatDateInput2" placeholder="" name="end_time" value="" />
                            <!--end::Input-->
                        </div>
