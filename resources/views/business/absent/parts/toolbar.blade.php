...
<div class="card-toolbar">
    ...
    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
        <!--begin::Filter-->
        <form class="w-150px me-3" id="listForm" method="get">
            <!--begin::Select2-->
            <select class="form-select form-select-solid" name="listType" id="dateSelect" data-control="select2"
                    data-hide-search="true" data-placeholder="Aralık Seçiniz"
