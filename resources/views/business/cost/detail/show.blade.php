        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                ...
                <div class="tab-content" id="myTabContent">
                    @include('business.cost.detail.component.tabs.edit')
...
@section('scripts')
    <script>
        let updateUrl = "{{route('business.cost.update', $cost->id)}}";
    </script>

    <script src="/business/assets/js/project/cost/details/update-profile.js"></script>
    <script>
