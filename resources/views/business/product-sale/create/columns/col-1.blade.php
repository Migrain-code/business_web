        ...
        <div class="card-body pt-0">
            <div class="d-flex flex-column gap-3">
                ...
                <div class="fv-row">
                    ...
                    <!--begin::Editor-->
                    <input id="kt_ecommerce_edit_order_date" name="seller_date" placeholder="Tarih Seçiniz" class="form-control mb-2" value="">
                    <!--end::Editor-->
                ...
                <div class="fv-row">
                    ...
                    <!--begin::Editor-->
                    <textarea name="note" placeholder="Not" rows="7" class="form-control mb-2"></textarea>
                    <!--end::Editor-->
