<div id="context-menu">
    ...
    <a href="{{ route('business.appointment.index') }}" id="create-appointment">
        <i class="fa fa-calendar-plus"></i> Randevu Oluştur
        <span class="shortcut">*</span>
    </a>
    <a href="{{ route('business.appointment.index') }}" id="create-appointment">
        <i class="fa fa-calendar-plus"></i> Saat Kapat
        <span class="shortcut">*</span>
    </a>
    <a href="{{ route('business.adission.index') }}" id="create-bill">
        <i class="fa fa-receipt"></i> Adisyon Oluştur
        <span class="shortcut">*</span>
    </a>

    <a href="{{ route('business.service.index') }}" id="create-service">
        <i class="fa fa-receipt"></i> Hizmet Oluştur
        <span class="shortcut">*</span>
    </a>
