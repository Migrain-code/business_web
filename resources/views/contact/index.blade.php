                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="info-item">
                                    ...
                                    <p><a href="#">{{setting('business_contact_phone')}}</a></p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="info-item">
                                    ...
                                    <p><a href="#">{{setting('business_contact_address')}}</a></p>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="info-item">
                                    ...
                                    <p><a href="mailto:{{setting('business_contact_email')}}">{{setting('business_contact_email')}}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
