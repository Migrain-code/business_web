...
var KTCustomersList = function () {
    ...
    function initExportButtons() {
        const reportTitle = "Destek Talebi Raporu";
    ...
    function printSaleReport() {
        ...
        printWindowPayment.document.write('<html><head><title>Destek Talebi Raporu</title>');
        ...
        printWindowPayment.document.write('</head><div class="card-header p-3 text-center d-flex justify-content-between"><h3>Destek Talebi Raporu</h3><span>'+formattedDateTime+'</span></div>');
