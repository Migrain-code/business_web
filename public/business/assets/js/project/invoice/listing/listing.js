...
var KTCustomersList = function () {
    ...
    function printSaleReport() {
        ...
        printWindowPayment.document.write('<html><head><title>Faturalarım</title>');
        ...
        printWindowPayment.document.write('</head><div class="card-header p-3 text-center d-flex justify-content-between"><h3>Faturalarım</h3><span>'+formattedDateTime+'</span></div>');
        ...
        $('#datatable').find('tr').each(function() {
            $(this).find('td:eq(6), th:eq(6)').show(); // 0 tabanlı indexleme olduğu için 4. sütunu gizliyoruz
        });
    }
    // Public methods
    return {
