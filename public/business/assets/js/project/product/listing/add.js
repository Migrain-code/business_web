...
var KTModalCustomersAdd = function () {
    ...
    var handleForm = function () {
            ...
            form,
            {
                fields: {
                    'name': {
                        validators: {
                            notEmpty: {
                                message: 'Ürün Adı Alanı Gereklidir'
                            }
                        }
                    },
                    'price': {
                    ...
                    'amount': {
                        validators: {
                            notEmpty: {
                                message: 'Stok Adedi Alanı Gereklidir'
                            }
                        }
                    },
                },
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function() {
                            ...
                            formData.append("barcode", $('[name="barcode"]').val());
                            $.ajax({
                                url: '/isletme/product',
                                type: "POST",
                                data: formData,
        ...
        cancelButton.addEventListener('click', function (e) {
            ...
            Swal.fire({
                text: "Ürün Ekleme İşlemini İptal Etmek İstediğinize Eminmisiniz?",
                icon: "warning",
