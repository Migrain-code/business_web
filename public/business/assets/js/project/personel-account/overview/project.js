...
var KTProjectOverview = function () {
    var t = KTUtil.getCssVariableValue("--bs-primary"), e = KTUtil.getCssVariableValue("--bs-primary-light"),
        ...
        o = KTUtil.getCssVariableValue("--bs-danger-200"), n = KTUtil.getCssVariableValue("--bs-danger-500");
    return {
        init: function () {
            var s, i;
            !function () {
                ...
                if (t) {
                    ...
                    new Chart(e, {
                        type: "doughnut",
                        data: {
                            datasets: [{data: appointmentData, backgroundColor: ["#00A3FF", "#50CD89", "#f1416c"]}],
                            labels: ["Onaylanmış", "Tamamlanmış", "İptal Edilmiş"]
                        },
                        options: {
