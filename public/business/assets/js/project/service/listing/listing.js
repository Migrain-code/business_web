...
var KTCustomersList = function () {
    ...
    function initExportButtons() {
        const reportTitle = "Hizmet Listesi";
    ...
    function printSaleReport() {
        ...
        printWindowPayment.document.write('<html><head><title>Hizmet Raporu</title>');
        ...
        printWindowPayment.document.write('</head><div class="card-header p-3 text-center d-flex justify-content-between"><h3>Hizmet Raporu</h3><span>'+formattedDateTime+'</span></div>');
