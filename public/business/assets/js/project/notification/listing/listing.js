...
var KTCustomersList = function () {
    ...
    var initCustomerList = function () {
        ...
        tableRows.forEach(row => {
            ...
            const realDate = moment(dateRow[0].innerHTML, "DD MMM YYYY, LT").format(); // select date from 5th column in table
    ...
    function printSaleReport() {
        ...
        printWindowPayment.document.write('<html><head><title>Bildirimler</title>');
        ...
        printWindowPayment.document.write('</head><div class="card-header p-3 text-center d-flex justify-content-between"><h3>Bildirimler</h3><span>'+formattedDateTime+'</span></div>');
