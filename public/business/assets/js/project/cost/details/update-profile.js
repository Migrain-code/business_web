			...
			form,
			{
                fields: {
                    ...
                    'category_id': {
                        validators: {
                            notEmpty: {
                                message: 'Masraf Kategorisi Alanı Gereklidir'
                            }
                        }
                    },
                    'payment_id': {
                        validators: {
                            notEmpty: {
                                message: 'Ödeme Türü Alanı Gereklidir'
                            }
                        }
                    },
                    'price': {
				...
				validator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
                            ...
                            formData.append("personelId", $('[name="personel_id"]').val());
                            formData.append("costCategoryId", $('[name="category_id"]').val());
                            formData.append("paymentTypeId", $('[name="payment_id"]').val());
                            formData.append("price", $('[name="price"]').val());
                            formData.append("operationDate", $('[name="operation_date"]').val());
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            if (res.status == "success"){
                                                window.location.href = "/isletme/cost";
                                            }
                                        }
                                    });
