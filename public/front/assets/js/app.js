...
$(".business-page-slider .owl-carousel").owlCarousel({
  loop: true,
  margin: 9,
  nav: true,
  items: 2,
...
$(document).ready(function () {
  $(".collapse-open").click(function () {
    var clickedFooterList = $(this).next(".footerList");
    $(".footerList").not(clickedFooterList).hide();
...
$(document).ready(function () {
  $(".aut-number input").on("input", function (e) {
    var $this = $(this);
    var val = $this.val();
  ...
  $(".aut-number input").on("keydown", function (e) {
